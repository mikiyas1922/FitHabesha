    ...
    <div className="min-h-screen flex bg-bg">
      <div className="hidden lg:flex lg:w-1/2 bg-dark items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative max-w-md">
          ...
          <h2 className="text-3xl font-bold text-foreground mb-4">Sign In</h2>
          <p className="text-muted leading-relaxed">
            Access your dashboard. Manage members, track workouts, and grow your gym business with Fit Habesha.
          </p>
        </div>
      </div>
